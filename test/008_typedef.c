...
int main()
{
    ...
    ASSERT(13, ({ typedef int t; t t=13; t; }));
    ASSERT(4, ({ typedef meanless_int; sizeof(meanless_int); }));
    ASSERT(30, ({ typedef meanless_int; meanless_int x=30;x; }));
    ASSERT(3, ({ MyInt x=3; x; }));
    ASSERT(16, ({ MyInt2 x; sizeof(x); }));
    ASSERT(8, ({ MyInt3 x; sizeof(x); }));
    ASSERT(4, ({ typedef t; t x=1; sizeof(x); }));
